...
class UpdateCustomDateTimePicker extends StatefulWidget {
  UpdateCustomDateTimePicker({super.key, this.onSave, this.dateTime});
  final Function(DateTime? time)? onSave;
  DateTime? dateTime;
  @override
  State<UpdateCustomDateTimePicker> createState() =>
      _CustomDateTimePickerState();
}

class _CustomDateTimePickerState extends State<UpdateCustomDateTimePicker> {
  @override
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        IconButton(
            onPressed: () async {
              widget.dateTime = await showOmniDateTimePicker(
                  context: context,
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Text(
              widget.dateTime != null ? formatDate(widget.dateTime!) : '-',
