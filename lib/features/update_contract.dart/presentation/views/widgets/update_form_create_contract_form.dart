...
class UpdateFormCreateContractForm extends StatefulWidget {
  const UpdateFormCreateContractForm({
    super.key,
    required this.title,
    this.onSave,
    this.validator,
  ...
  @override
  State<UpdateFormCreateContractForm> createState() =>
      _FormCreateContractFormState();
}

class _FormCreateContractFormState extends State<UpdateFormCreateContractForm> {
